import { g as get_store_value, c as create_ssr_component, a as subscribe, e as escape, b as add_attribute, v as validate_component } from "../../chunks/index3.js";
import { w as writable } from "../../chunks/index2.js";
const themeHamlindigo = "";
const skeleton = "";
const app = "";
const stores = {};
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-1q10wyj_START -->${$$result.title = `<title>Horlogeforum.nl - marktview</title>`, ""}<!-- HEAD_svelte-1q10wyj_END -->`, ""}
${validate_component(LightSwitch, "LightSwitch").$$render($$result, { class: "float-right mr-2 mt-2" }, {}, {})}
